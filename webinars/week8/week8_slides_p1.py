...
dt1 = dt.datetime(year=2022, month=11, day=1)
...
delta  = dt.datetime(2020,12, 31,0)
delta = dt.timedelta(hours=12)
utils.pprint(delta, pretty=False)
utils.pprint(delta.datys, "delta.days")
utils.pprint(delta.hours, "delta.hours")
